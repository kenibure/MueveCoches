...
public class Enemy01GeneratorController : GenericEnemyGeneratorController {
    ...
    private float generatorSpeedLimiter = 0.71f; //Es la velocidad límite a la que se pueden generar enemigos más rápido que esto (número más bajo). Una vez llega ahí el incremento de la velocidad es mucho más lento.
